...
const Sales = () => {
  ...
  return <section id="sales" className="bg-card py-[37px]">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          msOverflowStyle: 'none'
            ...
            {products.map((product, index) => <Card key={index} className="flex-shrink-0 w-80 border-border hover:border-primary/20 transition-colors">
        ...
        <div className="text-center mt-12">
          <div className="bg-muted/50 rounded-lg p-6 max-w-2xl mx-auto px-[23px] py-0">
